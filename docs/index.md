...
This project aims to reduce cognitive load and answer these questions for you by combining best practices

for AWS Lambda, Serverless CI/CD, and AWS CDK in one template project.
