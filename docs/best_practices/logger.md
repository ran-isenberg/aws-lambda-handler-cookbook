...
Read more about the importance of the logger and how to use AWS CloudWatch logs in [my blog post on logging](https://ranthebuilder.cloud/blog/aws-lambda-cookbook-elevate-your-handler-s-code-part-1-logging/){:target="_blank" rel="noopener"}.
