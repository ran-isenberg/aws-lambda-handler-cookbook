...
The JSON configuration that is uploaded to AWS AppConfig resides under ``cdk/aws_lambda_handler_cookbook/service_stack/configuration/json/dev_configuration.json``
