...
The repository also ships persistent instructions for [Claude Code](https://claude.com/claude-code) and other `CLAUDE.md`-aware AI agents, so generated code follows the project's conventions automatically:
